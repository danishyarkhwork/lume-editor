...
export function ToolbarDivider() {
  return (
    <div className="w-px h-6 bg-gradient-to-b from-transparent via-gray-300/60 to-transparent dark:via-gray-600/60 mx-1" />
  );
}

export function ToolbarGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-1 rounded-md px-1 py-0.5 h-8 flex-shrink-0 bg-gray-50/50 dark:bg-gray-900/50 backdrop-blur-sm border border-gray-200/40 dark:border-gray-800/40 min-w-fit">
      {children}
    </div>
  );
}
