  ...
  const toolbarChildren = useMemo(() => {
    ...
    React.Children.forEach(children, (child) => {
      ...
      if (componentName.includes("FloatingToolbarPlugin")) {
        ...
        // FormattingSidebarPlugin is now merged into AdvancedToolbarPlugin, skip it
        // Keep it in other so it doesn't break, but it returns null
        other.push(child);
      ...
      <div className={`editor-wrapper relative ${className}`}>
        <div className="editor-container relative bg-white dark:bg-gray-950 rounded-2xl border border-gray-200/60 dark:border-gray-800/60 min-h-[500px] shadow-xl shadow-gray-200/50 dark:shadow-gray-900/50 backdrop-blur-sm overflow-hidden flex flex-col focus:outline-none focus:border-gray-200/60 dark:focus:border-gray-800/60">
          ...
          <div className="sticky top-0 z-10 bg-white/70 dark:bg-gray-950/70 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-800/50">
            <div className="w-full overflow-x-auto md:overflow-x-auto overflow-y-visible scrollbar-hide">
              <div className="flex items-center min-h-[44px] md:min-h-[44px]">
          ...
          {/* Editor content area */}
          <div className="editor-inner relative px-4 py-6 min-h-[500px] flex-1 overflow-y-auto focus:outline-none focus:border-none">
            <RichTextPlugin
              contentEditable={
                <ContentEditable className="editor-input min-h-[450px] focus:outline-none focus:border-none focus:ring-0 prose prose-lg dark:prose-invert max-w-none" />
              }
